          ...
          <div className="col-xs-12 col-sm-8">
            ...
            <div className="btn-group">
              ...
              <ul className="dropdown-menu" role="menu">
                <li><a href={this.state.facebook} target="_blank">Facebook</a></li>
                <li><a href={this.state.gplus} target="_blank">Google+</a></li>
            ...
            <div className="btn-group">
              ...
              <ul className="dropdown-menu" role="menu">
                <li><a href={this.state.github} target="_blank">Github</a></li>
                <li><a href={this.state.codeforces} target="_blank">Codeforces</a></li>
              </ul>
            </div>
          </div>
        </div>
